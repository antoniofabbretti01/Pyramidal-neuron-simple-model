Here a simple model of an excitatory pyramidal neuron taken from the paper of Dalla Porta et al. 2025 !!!!, which is an extension of a previous model by Compte et al. 2002,!!!! 
transposed from C++ language to the Neuron Python language. As in the original work, the neuron has only a somatic and a dendritic compartment.
